class mydevops_blog::staging_ruby($blogruby=true) {

if $blogruby {
   
    include mydevops_blog::staging_ruby::blogruby
...
class mydevops_blog::staging_ruby::blogruby {

 $dependencies = ['ruby-dev','libxml2-dev','libxslt1-dev', 'libsasl2-dev', 'libpq-dev', 'liblzma-dev', 'apache2-dev']
